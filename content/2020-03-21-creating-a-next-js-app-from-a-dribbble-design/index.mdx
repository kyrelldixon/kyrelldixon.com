...
Before we get into it, [this](https://lonely-planet.now.sh/) is the link to the web app and [this](https://github.com/kyrelldixon/lonely-planet) is a link to the Github repo if you want to see the code. The code is pretty clean if you ask me 😉.
